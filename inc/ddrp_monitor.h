...
public:
  ...
  struct {
    ...
    struct {
      ...
      uint64_t cfg_mismatch_change[NumDDRPMonitorConfigs]
                                  [NumDDRPMonitorConfigs];
      uint64_t cfg_mismatch_unchanged[NumDDRPMonitorConfigs]
                                     [NumDDRPMonitorConfigs];
    } hysterisis;
...
public:
  ...
  ~DDRPMonitor();
  void print_config(), dump_stats(), reset_stats(), reset_cycles(),
      set_params();
