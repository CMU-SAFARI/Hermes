...
OffchipPredRandom::OffchipPredRandom(uint32_t _cpu, string _type,
                                     uint64_t _seed)
...
void OffchipPredRandom::train(ooo_model_instr *arch_instr, uint32_t data_index,
                              LSQ_ENTRY *lq_entry)
{
  // nothing to train
}

bool OffchipPredRandom::predict(ooo_model_instr *arch_instr,
