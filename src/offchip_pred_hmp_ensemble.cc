...
OffchipPredHMPEnsemble::OffchipPredHMPEnsemble(uint32_t _cpu, string _type,
                                               uint64_t _seed)
...
bool OffchipPredHMPEnsemble::predict(ooo_model_instr *arch_instr,
...
void OffchipPredHMPEnsemble::train(ooo_model_instr *arch_instr,
                                   uint32_t data_index, LSQ_ENTRY *lq_entry)
{
