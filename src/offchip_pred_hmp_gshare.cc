...
{
  cout << "ocp_hmp_gshare_history_length "
       << knob::ocp_hmp_gshare_history_length << endl
       << "ocp_hmp_gshare_pc_hash_type " << knob::ocp_hmp_gshare_pc_hash_type
       << endl
       << endl;
}
...
void OffchipPredHMPGshare::dump_stats()
{
  cout << "ocp_hmp_gshare_predict_called " << stats.predict.called << endl
       ...
       << "ocp_hmp_gshare_train_strong_nt_to_weak_nt "
       << stats.train.strong_nt_to_weak_nt << endl
       << "ocp_hmp_gshare_train_strong_nt_to_strong_nt "
       << stats.train.strong_nt_to_strong_nt << endl
       << "ocp_hmp_gshare_train_weak_nt_to_weak_t "
       << stats.train.weak_nt_to_weak_t << endl
       << "ocp_hmp_gshare_train_weak_nt_to_strong_nt "
       << stats.train.weak_nt_to_strong_nt << endl
       << "ocp_hmp_gshare_train_weak_t_to_strong_t "
       << stats.train.weak_t_to_strong_t << endl
       << "ocp_hmp_gshare_train_weak_t_to_weak_nt "
       << stats.train.weak_t_to_weak_nt << endl
       << "ocp_hmp_gshare_train_strong_t_to_strong_t "
       << stats.train.strong_t_to_strong_t << endl
       << "ocp_hmp_gshare_train_strong_t_to_weak_t "
...
OffchipPredHMPGshare::OffchipPredHMPGshare(uint32_t _cpu, string _type,
                                           uint64_t _seed)
...
bool OffchipPredHMPGshare::predict(ooo_model_instr *arch_instr,
...
void OffchipPredHMPGshare::train(ooo_model_instr *arch_instr,
                                 uint32_t data_index, LSQ_ENTRY *lq_entry)
{
  stats.train.called++;
...
uint32_t OffchipPredHMPGshare::get_hash(uint64_t pc)
{
  ...
  uint32_t hashed_pc =
      HashZoo::getHash(knob::ocp_hmp_gshare_pc_hash_type, folded_pc);
