...
void Scooby::init_knobs()
{
  ...
  std::copy(knob::scooby_actions.begin(), knob::scooby_actions.end(),
            Actions.begin());
  ...
  assert(knob::scooby_pref_degree >= 1 &&
         (knob::scooby_pref_degree == 1 || !knob::scooby_enable_dyn_degree));
  assert(knob::scooby_max_to_avg_q_thresholds.size() ==
         knob::scooby_dyn_degrees.size() - 1);
  assert(knob::scooby_last_pref_offset_conf_thresholds.size() ==
         knob::scooby_dyn_degrees_type2.size() - 1);
}
...
Scooby::Scooby(string type, CACHE *cache) : Prefetcher(type), parent(cache)
{
  ...
  if (knob::scooby_enable_featurewise_engine) {
    brain_featurewise = new LearningEngineFeaturewise(
        this, knob::scooby_alpha, knob::scooby_gamma, knob::scooby_epsilon,
        knob::scooby_max_actions, knob::scooby_seed, knob::scooby_policy,
        knob::scooby_learning_type, knob::scooby_brain_zero_init);
  } else {
    brain = new LearningEngineBasic(
        this, knob::scooby_alpha, knob::scooby_gamma, knob::scooby_epsilon,
        knob::scooby_max_actions, knob::scooby_max_states, knob::scooby_seed,
        knob::scooby_policy, knob::scooby_learning_type,
        knob::scooby_brain_zero_init, knob::scooby_early_exploration_window);
  }
...
void Scooby::print_config()
{
  cout << "scooby_alpha " << knob::scooby_alpha << endl
       ...
       << "scooby_reward_correct_untimely "
       << knob::scooby_reward_correct_untimely << endl
       << "scooby_reward_correct_timely " << knob::scooby_reward_correct_timely
       << endl
       << "scooby_brain_zero_init " << knob::scooby_brain_zero_init << endl
       << "scooby_enable_reward_all " << knob::scooby_enable_reward_all << endl
       << "scooby_enable_track_multiple " << knob::scooby_enable_track_multiple
       << endl
       << "scooby_enable_reward_out_of_bounds "
       << knob::scooby_enable_reward_out_of_bounds << endl
       << "scooby_reward_out_of_bounds " << knob::scooby_reward_out_of_bounds
       << endl
       ...
       << "scooby_print_access_debug " << knob::scooby_print_access_debug
       << endl
       << "scooby_print_access_debug_pc " << hex
       << knob::scooby_print_access_debug_pc << dec << endl
       << "scooby_print_access_debug_pc_count "
       << knob::scooby_print_access_debug_pc_count << endl
       << "scooby_print_trace " << knob::scooby_print_trace << endl
       << "scooby_enable_state_action_stats "
       << knob::scooby_enable_state_action_stats << endl
       << "scooby_enable_reward_tracker_hit "
       << knob::scooby_enable_reward_tracker_hit << endl
       << "scooby_reward_tracker_hit " << knob::scooby_reward_tracker_hit
       << endl
       << "scooby_enable_featurewise_engine "
       << knob::scooby_enable_featurewise_engine << endl
       << "scooby_pref_degree " << knob::scooby_pref_degree << endl
       << "scooby_enable_dyn_degree " << knob::scooby_enable_dyn_degree << endl
       << "scooby_max_to_avg_q_thresholds "
       << array_to_string(knob::scooby_max_to_avg_q_thresholds) << endl
       << "scooby_dyn_degrees " << array_to_string(knob::scooby_dyn_degrees)
       << endl
       << "scooby_multi_deg_select_type " << knob::scooby_multi_deg_select_type
       << endl
       << "scooby_last_pref_offset_conf_thresholds "
       << array_to_string(knob::scooby_last_pref_offset_conf_thresholds) << endl
       << "scooby_dyn_degrees_type2 "
       << array_to_string(knob::scooby_dyn_degrees_type2) << endl
       << "scooby_action_tracker_size " << knob::scooby_action_tracker_size
       << endl
       << "scooby_high_bw_thresh " << knob::scooby_high_bw_thresh << endl
       << "scooby_enable_hbw_reward " << knob::scooby_enable_hbw_reward << endl
       << "scooby_reward_hbw_correct_timely "
       << knob::scooby_reward_hbw_correct_timely << endl
       << "scooby_reward_hbw_correct_untimely "
       << knob::scooby_reward_hbw_correct_untimely << endl
       << "scooby_reward_hbw_incorrect " << knob::scooby_reward_hbw_incorrect
       << endl
       << "scooby_reward_hbw_none " << knob::scooby_reward_hbw_none << endl
       << "scooby_reward_hbw_out_of_bounds "
       << knob::scooby_reward_hbw_out_of_bounds << endl
       << "scooby_reward_hbw_tracker_hit "
       << knob::scooby_reward_hbw_tracker_hit << endl
       << "scooby_last_pref_offset_conf_thresholds_hbw "
       << array_to_string(knob::scooby_last_pref_offset_conf_thresholds_hbw)
       << endl
       << "scooby_dyn_degrees_type2_hbw "
       << array_to_string(knob::scooby_dyn_degrees_type2_hbw) << endl
       << "scooby_enable_direct_pref_issue "
       << knob::scooby_enable_direct_pref_issue << endl
       << "scooby_pref_at_lower_level " << knob::scooby_pref_at_lower_level
       << endl
       << endl
       ...
       << endl
       << "le_featurewise_active_features "
       << print_active_features2(knob::le_featurewise_active_features) << endl
       << "le_featurewise_num_tilings "
       << array_to_string(knob::le_featurewise_num_tilings) << endl
       << "le_featurewise_num_tiles "
       << array_to_string(knob::le_featurewise_num_tiles) << endl
       << "le_featurewise_hash_types "
       << array_to_string(knob::le_featurewise_hash_types) << endl
       << "le_featurewise_enable_tiling_offset "
       << array_to_string(knob::le_featurewise_enable_tiling_offset) << endl
       << "le_featurewise_max_q_thresh " << knob::le_featurewise_max_q_thresh
       << endl
       << "le_featurewise_enable_action_fallback "
       << knob::le_featurewise_enable_action_fallback << endl
       << "le_featurewise_feature_weights "
       << array_to_string(knob::le_featurewise_feature_weights) << endl
       << "le_featurewise_enable_dynamic_weight "
       << knob::le_featurewise_enable_dynamic_weight << endl
       << "le_featurewise_weight_gradient "
       << knob::le_featurewise_weight_gradient << endl
       << "le_featurewise_disable_adjust_weight_all_features_align "
       << knob::le_featurewise_disable_adjust_weight_all_features_align << endl
       << "le_featurewise_selective_update "
       << knob::le_featurewise_selective_update << endl
       << "le_featurewise_pooling_type " << knob::le_featurewise_pooling_type
       << endl
       << "le_featurewise_enable_dyn_action_fallback "
       << knob::le_featurewise_enable_dyn_action_fallback << endl
       << "le_featurewise_bw_acc_check_level "
       << knob::le_featurewise_bw_acc_check_level << endl
       << "le_featurewise_acc_thresh " << knob::le_featurewise_acc_thresh
       << endl
       << "le_featurewise_enable_trace " << knob::le_featurewise_enable_trace
       << endl
       << "le_featurewise_trace_feature_type "
       << knob::le_featurewise_trace_feature_type << endl
       << "le_featurewise_trace_feature " << knob::le_featurewise_trace_feature
       << endl
       << "le_featurewise_trace_interval "
       << knob::le_featurewise_trace_interval << endl
       << "le_featurewise_trace_record_count "
       << knob::le_featurewise_trace_record_count << endl
       << "le_featurewise_trace_file_name "
       << knob::le_featurewise_trace_file_name << endl
       << "le_featurewise_enable_score_plot "
       << knob::le_featurewise_enable_score_plot << endl
       << "le_featurewise_plot_actions "
       << array_to_string(knob::le_featurewise_plot_actions) << endl
       << "le_featurewise_plot_file_name "
       << knob::le_featurewise_plot_file_name << endl
       << endl;
}

void Scooby::invoke_prefetcher(uint64_t pc, uint64_t address, uint8_t cache_hit,
                               uint8_t type, vector<uint64_t> &pref_addr)
{
  ...
  MYLOG(
      "---------------------------------------------------------------------");
  MYLOG("%s %lx pc %lx page %lx off %u", GetAccessType(type), address, pc, page,
        offset);
  ...
  if (knob::scooby_enable_direct_pref_issue) {
    for (uint32_t addr_index = 0; addr_index < pref_addr.size(); ++addr_index) {
      parent->prefetch_line(
          pc, address, pref_addr[addr_index],
          knob::scooby_pref_at_lower_level ? FILL_LLC : FILL_L2, 0);
    }
    pref_addr.clear();
  }
}

void Scooby::update_global_state(uint64_t pc, uint64_t page, uint32_t offset,
                                 uint64_t address)
{
  /* @rbera TODO: implement */
}

Scooby_STEntry *Scooby::update_local_state(uint64_t pc, uint64_t page,
                                           uint32_t offset, uint64_t address)
{
  stats.st.lookup++;
  Scooby_STEntry *stentry  = NULL;
  auto            st_index = find_if(
      signature_table.begin(), signature_table.end(),
      [page](Scooby_STEntry *stentry) { return stentry->page == page; });
...
uint32_t Scooby::predict(uint64_t base_address, uint64_t page, uint32_t offset,
                         State *state, vector<uint64_t> &pref_addr)
{
  MYLOG("addr@%lx page %lx off %u state %x", base_address, page, offset,
        state->value());
  ...
  if (knob::scooby_enable_featurewise_engine) {
    ...
    if (knob::scooby_enable_dyn_degree) {
      pref_degree =
          get_dyn_pref_degree(max_to_avg_q_ratio, page, Actions[action_index]);
    }
  ...
  if (Actions[action_index] != 0) {
    ...
    if (predicted_offset >= 0 &&
        predicted_offset < 64) /* falls within the page */
    {
      ...
      if (new_addr) {
        ...
        if (pref_degree > 1) {
          gen_multi_degree_pref(page, offset, Actions[action_index],
                                pref_degree, pref_addr);
        }
...
bool Scooby::track(uint64_t address, State *state, uint32_t action_index,
                   Scooby_PTEntry **tracker)
{
  MYLOG("addr@%lx state %x act_idx %u act %d", address, state->value(),
  ...
  if (prefetch_tracker.size() >= knob::scooby_pt_size) {
    ...
    MYLOG("victim_state %x victim_act_idx %u victim_act %d",
          ptentry->state->value(), ptentry->action_index,
          Actions[ptentry->action_index]);
    if (last_evicted_tracker) {
      MYLOG("last_victim_state %x last_victim_act_idx %u last_victim_act %d",
            last_evicted_tracker->state->value(),
            last_evicted_tracker->action_index,
...
void Scooby::gen_multi_degree_pref(uint64_t page, uint32_t offset,
                                   int32_t action, uint32_t pref_degree,
  ...
  if (action != 0) {
    for (uint32_t degree = 2; degree <= pref_degree; ++degree) {
      ...
      if (predicted_offset >= 0 && predicted_offset < 64) {
        addr = (page << LOG2_PAGE_SIZE) + (predicted_offset << LOG2_BLOCK_SIZE);
        pref_addr.push_back(addr);
        MYLOG("degree %u pred_off %d pred_addr %lx", degree, predicted_offset,
              addr);
...
uint32_t Scooby::get_dyn_pref_degree(float max_to_avg_q_ratio, uint64_t page,
                                     int32_t action)
{
  ...
  if (knob::scooby_multi_deg_select_type == 2) {
    ...
    if (st_index != signature_table.end()) {
      ...
      conf_thresholds = is_high_bw()
                            ? knob::scooby_last_pref_offset_conf_thresholds_hbw
                            : knob::scooby_last_pref_offset_conf_thresholds;
      deg_normal      = is_high_bw() ? knob::scooby_dyn_degrees_type2_hbw
                                     : knob::scooby_dyn_degrees_type2;
...
void Scooby::reward(uint64_t address)
{
  ...
  vector<Scooby_PTEntry *> ptentries =
      search_pt(address, knob::scooby_enable_reward_all);
  ...
  for (uint32_t index = 0; index < ptentries.size(); ++index) {
    ...
    MYLOG("PT hit. state %x act_idx %u act %d", ptentry->state->value(),
          ptentry->action_index, Actions[ptentry->action_index]);
...
{
  MYLOG("reward PT evict %lx state %x act_idx %u act %d", ptentry->address,
        ptentry->state->value(), ptentry->action_index,
        Actions[ptentry->action_index]);
...
{
  MYLOG("assign_reward PT evict %lx state %x act_idx %u act %d",
        ptentry->address, ptentry->state->value(), ptentry->action_index,
        Actions[ptentry->action_index]);
  assert(!ptentry->has_reward);
...
{
  bool high_bw =
      (knob::scooby_enable_hbw_reward && is_high_bw()) ? true : false;
  int32_t reward = 0;

  stats.reward.compute_reward.dist[type][high_bw]++;

  if (type == RewardType::correct_timely) {
    reward = high_bw ? knob::scooby_reward_hbw_correct_timely
                     : knob::scooby_reward_correct_timely;
  } else if (type == RewardType::correct_untimely) {
    reward = high_bw ? knob::scooby_reward_hbw_correct_untimely
                     : knob::scooby_reward_correct_untimely;
  } else if (type == RewardType::incorrect) {
    reward = high_bw ? knob::scooby_reward_hbw_incorrect
    ...
    reward = high_bw ? knob::scooby_reward_hbw_out_of_bounds
                     : knob::scooby_reward_out_of_bounds;
  } else if (type == RewardType::tracker_hit) {
    reward = high_bw ? knob::scooby_reward_hbw_tracker_hit
                     : knob::scooby_reward_tracker_hit;
  } else {
...
{
  MYLOG("victim %s %u %d last_victim %s %u %d",
        curr_evicted->state->to_string().c_str(), curr_evicted->action_index,
        Actions[curr_evicted->action_index],
        last_evicted->state->to_string().c_str(), last_evicted->action_index,
        Actions[last_evicted->action_index]);
  ...
  /* train */
  MYLOG("===SARSA=== S1: %s A1: %u R1: %d S2: %s A2: %u",
        last_evicted->state->to_string().c_str(), last_evicted->action_index,
        last_evicted->reward, curr_evicted->state->to_string().c_str(),
        curr_evicted->action_index);
  if (knob::scooby_enable_featurewise_engine) {
    brain_featurewise->learn(
        last_evicted->state, last_evicted->action_index, last_evicted->reward,
        curr_evicted->state, curr_evicted->action_index,
        last_evicted->consensus_vec, last_evicted->reward_type);
  } else {
    brain->learn(last_evicted->state->value(), last_evicted->action_index,
                 last_evicted->reward, curr_evicted->state->value(),
                 curr_evicted->action_index);
  }
  MYLOG("train done");
}
...
void Scooby::register_fill(uint64_t address)
{
  ...
  if (!ptentries.empty()) {
    ...
    for (uint32_t index = 0; index < ptentries.size(); ++index) {
      ...
      MYLOG("fill PT hit. pref with act_idx %u act %d",
            ptentries[index]->action_index,
            Actions[ptentries[index]->action_index]);
    }
  }
}
...
void Scooby::register_prefetch_hit(uint64_t address)
{
  ...
  if (!ptentries.empty()) {
    ...
    for (uint32_t index = 0; index < ptentries.size(); ++index) {
      ...
      MYLOG("pref_hit PT hit. pref with act_idx %u act %d",
            ptentries[index]->action_index,
            Actions[ptentries[index]->action_index]);
    }
  }
                          ...
                          uint32_t pref_degree)
{
  ...
  if (it != state_action_dist.end()) {
    ...
    state_action_dist.insert(
        std::pair<uint32_t, vector<uint64_t>>(state, act_dist));
  }
}
...
void Scooby::update_stats(State *state, uint32_t action_index, uint32_t degree)
{
  ...
  if (it != state_action_dist2.end()) {
    ...
    act_dist[knob::scooby_max_actions]++; /* counts total occurences of this
                                             state */
    state_action_dist2.insert(
        std::pair<string, vector<uint64_t>>(state_str, act_dist));
  }
  ...
  if (it2 != action_deg_dist.end()) {
    ...
    deg_dist[degree]++;
    action_deg_dist.insert(std::pair<int32_t, vector<uint64_t>>(
        getAction(action_index), deg_dist));
  }
}
...
void Scooby::dump_stats()
{
  cout << "scooby_st_lookup " << stats.st.lookup << endl
       ...
       // endl
       << "scooby_predict_out_of_bounds " << stats.predict.out_of_bounds
       << endl;

  for (uint32_t index = 0; index < Actions.size(); ++index) {
    cout << "scooby_predict_action_" << Actions[index] << " "
         << stats.predict.action_dist[index] << endl;
    cout << "scooby_predict_issue_action_" << Actions[index] << " "
         << stats.predict.issue_dist[index] << endl;
    cout << "scooby_predict_hit_action_" << Actions[index] << " "
         << stats.predict.pred_hit[index] << endl;
    cout << "scooby_predict_out_of_bounds_action_" << Actions[index] << " "
         << stats.predict.out_of_bounds_dist[index] << endl;
  }

  cout << "scooby_predict_multi_deg_called " << stats.predict.multi_deg_called
       << endl
  ...
  for (uint32_t index = 2; index <= MAX_SCOOBY_DEGREE; ++index) {
    cout << "scooby_predict_multi_deg_" << index << " "
         << stats.predict.multi_deg_histogram[index] << endl;
  }
  cout << endl;
  for (uint32_t index = 1; index <= MAX_SCOOBY_DEGREE; ++index) {
    cout << "scooby_selected_deg_" << index << " "
         << stats.predict.deg_histogram[index] << endl;
  }
  cout << endl;
  ...
  if (knob::scooby_enable_state_action_stats) {
    if (knob::scooby_enable_featurewise_engine) {
      ...
      for (auto itr = state_action_dist2.begin();
           itr != state_action_dist2.end(); ++itr) {
        pairs.push_back(*itr);
      }
      sort(pairs.begin(), pairs.end(),
           [](std::pair<string, vector<uint64_t>> &a,
              std::pair<string, vector<uint64_t>> &b) {
             return a.second[knob::scooby_max_actions] >
                    b.second[knob::scooby_max_actions];
           });
      ...
      for (auto it = state_action_dist.begin(); it != state_action_dist.end();
           ++it) {
        cout << "scooby_state_" << hex << it->first << dec << " ";
        for (uint32_t index = 0; index < it->second.size(); ++index) {
          cout << it->second[index] << ",";
  ...
  cout << "scooby_track_called " << stats.track.called << endl
       ...
       << "scooby_reward_demand_pt_not_found "
       << stats.reward.demand.pt_not_found << endl
       << "scooby_reward_demand_pt_found " << stats.reward.demand.pt_found
       << endl
       << "scooby_reward_demand_pt_found_total "
       << stats.reward.demand.pt_found_total << endl
       << "scooby_reward_demand_has_reward " << stats.reward.demand.has_reward
       << endl
       << "scooby_reward_train_called " << stats.reward.train.called << endl
       << "scooby_reward_assign_reward_called "
       << stats.reward.assign_reward.called << endl
       << "scooby_reward_no_pref " << stats.reward.no_pref << endl
       << "scooby_reward_incorrect " << stats.reward.incorrect << endl
       << "scooby_reward_correct_untimely " << stats.reward.correct_untimely
       << endl
  ...
  for (uint32_t reward = 0; reward < RewardType::num_rewards; ++reward) {
    cout << "scooby_reward_" << getRewardTypeString((RewardType)reward)
         << "_low_bw " << stats.reward.compute_reward.dist[reward][0] << endl
         << "scooby_reward_" << getRewardTypeString((RewardType)reward)
         << "_high_bw " << stats.reward.compute_reward.dist[reward][1] << endl;
  }
  cout << endl;
  ...
  cout << endl
       ...
       << "scooby_register_fill_set_total " << stats.register_fill.set_total
       << endl
       << endl

       << "scooby_register_prefetch_hit_called "
       << stats.register_prefetch_hit.called << endl
       << "scooby_register_prefetch_hit_set " << stats.register_prefetch_hit.set
       << endl
       << "scooby_register_prefetch_hit_set_total "
       << stats.register_prefetch_hit.set_total << endl
       << endl
  ...
  for (auto itr = target_action_state.begin(); itr != target_action_state.end();
       ++itr) {
    pairs.push_back(*itr);
  }
  sort(pairs.begin(), pairs.end(),
       [](std::pair<string, uint64_t> &a, std::pair<string, uint64_t> &b) {
  ...
  for (uint32_t index = 0; index < DRAM_BW_LEVELS; ++index) {
    cout << "scooby_bw_level_" << index << " "
         << stats.bandwidth.histogram[index] << endl;
  }
  cout << endl;

  cout << "scooby_ipc_epochs " << stats.ipc.epochs << endl;
  for (uint32_t index = 0; index < SCOOBY_MAX_IPC_LEVEL; ++index) {
    cout << "scooby_ipc_level_" << index << " " << stats.ipc.histogram[index]
         << endl;
  }
  cout << endl;
  ...
  for (uint32_t index = 0; index < CACHE_ACC_LEVELS; ++index) {
    cout << "scooby_cache_acc_level_" << index << " "
         << stats.cache_acc.histogram[index] << endl;
  }
  cout << endl;
}
